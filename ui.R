shinyUI(
  ...
  title = "Centers for Summer Planning Academy", # Internal Shiny title
  ...
  column(8, br(), strong(tags$div(class="mainpage_title", HTML(paste0("Regional Growth Centers:", "<br/>", "2024 Summer Planning Academy")))))),
  
  hr(style = "border-top: 1px solid #000000;"),
  fluidRow(column(12, style='padding-left:75px; padding-right:75px;', overview_ui('OVERVIEW'))),
  fluidRow(column(12, style='padding-left:75px; padding-right:75px;',  place_ui('RGC'))),
  hr(style = "border-top: 1px solid #000000;"),
